...
export interface AuthFormProps {
  ...
  error?: string;
  isLoading?: boolean;
  showTermsModal?: (formData?: AuthFormData) => void;
    ...
    <div className="d-flex justify-content-center">
      <div className={`card ${mode === "signin" ? "sign-in-card" : "register-card"} mt-5`}>
        <div className="card-body">
          ...
          <h2 className="card-title text-center">{isRegister ? "Create an account" : "Sign In"}</h2>
          <h6
            className={`card-subtitle mb-2 ${mode === "signin" ? "sign-in-card-subtitle" : "register-card-subtitle"} text-end me-4 pe-2 mb-3`}
          >
            {isRegister ? (
              <>
                ...
                <button
                  type="button"
                  onClick={onSwitch}
                  className="btn btn-link register-card-subtitle ps-1"
                >
                  Sign In
                </button>
              </>
              ...
              <>
                ...
                <button
                  type="button"
                  onClick={onSwitch}
                  className="btn btn-link sign-in-card-subtitle ps-1"
                >
                  Register
                </button>
              </>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mx-4">
              <div>
                <label htmlFor={`${mode}-email`} className="form-label mb-0 mt-2">
                  Email
                </label>
              </div>
              <input
              ...
              {emailError && (
                <h5
                  className={`text-danger mt-2 ${isRegister ? "register-message-errors" : "sign-in-message-errors"}`}
                >
                  {emailError}
                </h5>
              )}
              ...
              <div className="mt-3">
                ...
                <div
                  className={`d-flex ${isRegister ? "btn-register-card-border" : "btn-sign-in-card-border"} rounded-2`}
                >
                  <input
                ...
                {passwordErrors.length > 0 && (
                  <h5
                    className={`mt-2 ${isRegister ? "register-message-errors" : "sign-in-message-errors"} ${isRegister ? "text-warning" : "text-danger"}`}
                  >
                ...
                <>
                  <div className="mt-2">
                    ...
                    >
                      ...
                      >
                        <i
                          className={`fa-solid ${showRepeatPassword ? "fa-eye-slash" : "fa-eye"}`}
                        ></i>
                      </span>
                    </div>
                  </div>
              ...
              {!isRegister && (
                <div
                  className={`form-text ${isRegister ? "register-password-subtitle" : "sign-in-password-subtitle"} mt-2`}
                  id="basic-addon4"
                >
